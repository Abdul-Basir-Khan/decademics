...
class DiscardDialogStd extends StatefulWidget {
  const DiscardDialogStd({Key? key}) : super(key: key);

  @override
  State<DiscardDialogStd> createState() => _DiscardDialogStdState();
}

class _DiscardDialogStdState extends State<DiscardDialogStd> {
  @override
