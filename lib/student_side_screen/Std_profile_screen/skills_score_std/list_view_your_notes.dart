...
class ListViewYourNotes extends StatefulWidget {
  const ListViewYourNotes({
    Key? key,
  }) : super(key: key);

  @override
  State<ListViewYourNotes> createState() => _ListViewYourNotesState();
}

class _ListViewYourNotesState extends State<ListViewYourNotes> {
  int _current = 0;
