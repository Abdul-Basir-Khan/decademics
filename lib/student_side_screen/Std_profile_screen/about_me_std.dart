...
class AboutMeScreenStd extends StatefulWidget {
  const AboutMeScreenStd({Key? key}) : super(key: key);

  @override
  State<AboutMeScreenStd> createState() => _AboutMeScreenStdState();
}

class _AboutMeScreenStdState extends State<AboutMeScreenStd> {
  @override
