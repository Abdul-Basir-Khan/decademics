...
import 'check_email_done_std.dart';
import 'check_mail_std.dart';

class CreateNewPasswordScreenStd extends StatefulWidget {
  const CreateNewPasswordScreenStd({Key? key}) : super(key: key);

  @override
  State<CreateNewPasswordScreenStd> createState() => _CreateNewPasswordScreenStdState();
}

class _CreateNewPasswordScreenStdState extends State<CreateNewPasswordScreenStd> {
          ...
          child: ListView(
            ...
            const  Center(
              ...
              InkWell(
                onTap: (){
                  setState(() {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>const CheckEmailDoneScreenStd()));
                  });
                },
                child:
                Container(
