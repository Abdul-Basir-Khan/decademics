...
class WeekScreensStd extends StatefulWidget {
  final String category;

  const WeekScreensStd({Key? key, required this.category}) : super(key: key);

  @override
  State<WeekScreensStd> createState() => _WeekScreensStdState();
}

class _WeekScreensStdState extends State<WeekScreensStd> {
  int selectedIndex = 1;
