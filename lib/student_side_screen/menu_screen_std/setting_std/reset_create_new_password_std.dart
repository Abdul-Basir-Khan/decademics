...
import 'package:deckademics/Instructor_Side_Screens/setting_screen/reset_password_done.dart';
import 'package:deckademics/student_side_screen/menu_screen_std/setting_std/reset_password_done_std.dart';
...
class ResetCreateNewPasswordScreenStd extends StatefulWidget {
  const ResetCreateNewPasswordScreenStd({Key? key}) : super(key: key);

  @override
  State<ResetCreateNewPasswordScreenStd> createState() => _ResetCreateNewPasswordScreenStdState();
}

class _ResetCreateNewPasswordScreenStdState extends State<ResetCreateNewPasswordScreenStd> {
          ...
          child: ListView(
            children: [
              ...
              InkWell(
                onTap: (){
                  setState(() {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>const ResetPasswordDoneScreenStd()));
                  });
                },
                child:
                Container(
