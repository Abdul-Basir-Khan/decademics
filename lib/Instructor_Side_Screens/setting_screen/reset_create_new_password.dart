...
class ResetCreateNewPasswordScreen extends StatefulWidget {
  const ResetCreateNewPasswordScreen({Key? key}) : super(key: key);

  @override
  State<ResetCreateNewPasswordScreen> createState() => _ResetCreateNewPasswordScreenState();
}

class _ResetCreateNewPasswordScreenState extends State<ResetCreateNewPasswordScreen> {
          ...
          child: ListView(
            children: [
              ...
              InkWell(
                onTap: (){
                  setState(() {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>const ResetPasswordDoneScreen()));
                  });
                },
                child:
                Container(
